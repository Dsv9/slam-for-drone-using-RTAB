...
class _SmokeNode(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter("creep_x", 0.012)
        self.declare_parameter("yaw_z", 0.0)
        self.declare_parameter("warmup_sec", 7.0)
        self.declare_parameter("phase2_max_sec", 40.0)
        self.declare_parameter("rate_hz", 7.0)
        self.declare_parameter("scan_enabled", True)
        self.declare_parameter("scan_wz", 0.032)
        self.declare_parameter("scan_leg_sec", 5.0)
        self.declare_parameter("scan_min_inliers", 8)
